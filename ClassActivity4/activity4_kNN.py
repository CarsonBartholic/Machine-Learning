...
featureSelection = SelectKBest(chi2, k=KVAL).fit_transform(xVal, yVal)                    # selects the top features
...
featureSelection_SCALED = SelectKBest(chi2, k=KVAL).fit_transform(xVal_SCALED, yVal)      # selects the top features
